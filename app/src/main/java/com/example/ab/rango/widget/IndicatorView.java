...
public class IndicatorView extends LinearLayout {
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        mDefaultSel = typedArray.getInt(
                R.styleable.IndicatorView_indicator_default_sel, 0);
        mCounter = typedArray.getInt(
                R.styleable.IndicatorView_indicator_counter, mCounter);
        mPadding = typedArray.getDimension(
                R.styleable.IndicatorView_indicator_padding, 0);
        mSize = typedArray.getDimension(
                R.styleable.IndicatorView_indicator_size, 0);

        mImageFocused = typedArray.getResourceId(
                R.styleable.IndicatorView_indicator_img_focused,
                R.drawable.guide_indicator_focused);
        mImageNormal = typedArray.getResourceId(
                R.styleable.IndicatorView_indicator_img_normal,
                R.drawable.guide_indicator);
    ...
    public void setUpView(int counter) {
        ...
        for (int i = 0; i < mCounter; i++) {
            ...
            mImages[i] = imageView;
            mImages[i].setBackgroundResource(
                    i == mDefaultSel ? mImageFocused : mImageNormal);
