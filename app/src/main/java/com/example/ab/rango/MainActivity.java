...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    Fragment fragmentTab1 = new NewsFeedFragment();
    Fragment fragmentTab2 = new PostFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageFetcher = new ImageFetcher(this, 960);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    return fragmentTab1;
                case 1:
                    //Fragment fragment2 = new PostFragment();
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.news_feed).toUpperCase(l);
                case 1:
                    return getString(R.string.post).toUpperCase(l);
                case 2:
